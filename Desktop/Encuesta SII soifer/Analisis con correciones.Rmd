...
prop.test(43, 251, p = NULL, conf.level = 0.95, correct = T)
...
dfr_n <- data.frame(k=c(53,49,48,47,45,42,33,31,27,24),n=rep(53,10))
Map(prop.test,x=dfr_n$k,n=dfr_n$n)

dfr_o <- data.frame(k=c(241, 223, 231, 219, 204, 142, 174, 90, 101, 99, 102),n=rep(251,11))
Map(prop.test,x=dfr_o$k,n=dfr_o$n)
