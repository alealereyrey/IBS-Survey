...
piramide <- ggplot(dfpiramide2, aes(x = Edad_ordinal, y = Especialistas, fill = Genero)) + 
  ...
  scale_fill_manual(values = c("cornflowerblue", "#E76BF3")) +
        labs(title = "Distribución de profesionales según edad y género", y = "Nro de especialistas", x = "Edad", fill = "Género", caption = "Gráfico 1: Distribución de los profesionales encuestados según género y edad") +
...
grafico_fisiopato_diarrea <- ggplot(fisiopato_diarrea, aes(x= `Fisiopatología más frecuente variante diarrea`, y = Proporcion, fill = `Orientación dicotómica`)) +
        ...
        geom_text(position = position_dodge(width = 1), aes (label = `Proporcion`), vjust = 0.5, hjust = -0.1) +
                        ...
                        theme_bw() +
                        coord_flip() +
        labs(title = "Fisiopatología más frecuente del SII-D", subtitle = "p-value = 0.5883", x = "Fisiopatología", y = "Porcentaje de respuestas") +
        expand_limits(y = c(0, 60))
...
grafico_fisiopato_constipacion <- ggplot(fisiopato_constipacion, aes(x= `Fisiopatología más frecuente variante constipación`, y = Proporcion, fill = `Orientación dicotómica`)) +
        ...
        geom_text(position = position_dodge(width = 1), aes (label = `Proporcion`), vjust = 0.5, hjust = -0.1) +
                        ...
                        theme_bw() +
                        coord_flip() +
        labs(title = "Fisiopatología más frecuente del SII-C", subtitle = "p-value = 0.4221", x = "Fisiopatología", y = "Porcentaje de respuestas") +
...
ggplot(edad_metas, aes(x=Edad_ordinal, y = Proporcion, fill = `Meta principal endel tratamiento del SII`)) +
        geom_col(position = "dodge") +
        geom_text(position = position_dodge2(width = 1), aes (label = `Proporcion`), vjust = -0.5) +
       labs(title = "Metas del tratamiento del SII en funcion de la edad", subtitle = "X-squared = 4.0575, df = 2, p-value = 0.1315", x = "Edad", y = "Proporción") +
        expand_limits(y = c(0, 60))
