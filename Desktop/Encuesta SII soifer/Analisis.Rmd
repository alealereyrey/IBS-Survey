...
diarrea <- encuesta[,c(14,20:32)]

diarrea <- diarrea %>%
        mutate(`Fisiopatología más frecuente variante diarrea` = case_when(str_detect(`Fisiopatología más frecuente variante diarrea`,regex("medicamentos")) ~ "Medicamentos",
...
diarrea <- diarrea %>%
        separate(., col = 2, into = "Bismuto", sep = ";", extra = "drop", fill = "right")%>%
        separate(., col = 3, into = "Rifaximina", sep = ";", extra = "drop", fill = "right")%>%
        separate(., col = 4, into = "Otros antibióticos", sep = ";", extra = "drop", fill = "right")%>%
        separate(., col = 5, into = "Probióticos", sep = ";", extra = "drop", fill = "right") %>%
        separate(., col = 6, into = "Trimebutina", sep = ";", extra = "drop", fill = "right") %>%
        separate(., col = 7, into = "Trimebutina/simeticona", sep = ";", extra = "drop", fill = "right")%>%
        separate(., col = 8, into = "Alverina/simeticona", sep = ";", extra = "drop", fill = "right") %>%
        separate(., col = 9, into = "Pinaverio", sep = ";", extra = "drop", fill = "right") %>%
        separate(., col = 10, into = "Otilonio", sep = ";", extra = "drop", fill = "right") %>%
        separate(., col = 11, into = "Colestiramina", sep = ";", extra = "drop", fill = "right")%>%
        separate(., col = 12, into = "Amitriptilina", sep = ";", extra = "drop", fill = "right")%>%
        separate(., col = 13, into = "Antiespasmódicos", sep = ";", extra = "drop", fill = "right")%>%
        separate(., col = 14, into = "Dieta", sep = ";", extra = "drop", fill = "right")
...
## grafico cada fisiopatologia

```{r}

grafico_estres <- ggplot(estres, 
                         aes(x = c()))
